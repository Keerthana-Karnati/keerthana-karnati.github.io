  ...
  const experience = [
    {
      ...
      description:
        "Developed end-to-end web features using React and Angular.js, delivering high-performance, user-centric solutions.",
    },
  ];
  ...
  const projects = [
    {
      ...
      description:
        "Comprehensive e-commerce platform with dynamic inventory management.",
    ...
    },
    {
      ...
      description:
        "Efficient ride-sharing application focusing on scalability and user experience.",
      tech: ["React", "MongoDB"],
      link: "#",
    },
    {
      ...
      description:
        "Modern, responsive personal brand site with smooth animations.",
      tech: [
        "Next JS",
        "React",
        "Tailwind CSS",
    ...
    },
    {
      ...
      description:
        "Full-stack enterprise application for hotel operations and guest management using layered architecture.",
      tech: [
        "Java",
        "SpringBoot",
        "MongoDB",
  ...
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-200 font-sans selection:bg-blue-500/30 transition-colors duration-300">
      <main className="max-w-5xl mx-auto px-6 pt-32 pb-20">
        ...
        <motion.section
          id="about"
          className="mb-24 md:mb-40 grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 items-start pt-10"
        >
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8 text-center md:text-left">
              {/* Picture Frame */}
              <div className="relative w-32 h-32 md:w-35 md:h-35 rounded-2xl overflow-hidden border border-blue-200 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-950/50 flex-shrink-0 shadow-sm">
                <img
              ...
              <div className="flex flex-col">
                ...
                <h2 className="text-2xl md:text-3xl font-extrabold tracking-tighter italic text-slate-900 dark:text-white leading-tight">
                  ...
                  <span className="text-blue-600 dark:text-blue-500 mx-1">
                    ·
                  </span>{" "}
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed max-w-xl">
              {/* On mobile: toggle between preview and full. On desktop (md:): always show full. */}
              ...
              <button
                ...
                className="md:hidden block mt-2 text-blue-600 dark:text-blue-400 font-bold text-xs uppercase tracking-[0.2em] hover:opacity-70 transition-opacity"
              >
          ...
          {/* Education Section - Stays similar but handles padding better */}
            ...
            <div className="space-y-6">
              {education.map((edu, i) => (
                <div key={i}>
                  ...
                  <p className="text-[10px] text-blue-700 dark:text-blue-900 mt-0.5">
                    {edu.duration}
                  </p>
                </div>
              ))}
        ...
        <section id="experience" className="mb-40 scroll-mt-24">
          <h3 className="text-[10px] font-bold mb-12 text-slate-400 dark:text-slate-600 uppercase tracking-[0.4em]">
            Experience
          </h3>
          <div className="space-y-12">
            {experience.map((exp, i) => (
              <div
                key={i}
                className="group relative pl-6 md:pl-8 border-l border-slate-200 dark:border-slate-900"
              >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-baseline mb-2 gap-1">
                  ...
                  <span className="text-[10px] md:text-xs text-blue-600 dark:text-blue-900 font-mono">
                    {exp.duration}
                  </span>
                </div>
                <p className="text-blue-600 dark:text-blue-500/70 text-sm mb-2 font-medium">
                  {exp.company}
                </p>
                <p className="text-slate-600 dark:text-slate-500 text-sm max-w-2xl">
                  {exp.description}
                </p>
              </div>
            ))}
        ...
        <section id="projects" className="mb-40 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {projects.map((project, index) => (
              <div
                key={index}
                className="p-6 md:p-8 rounded-2xl border border-blue-100 dark:border-blue-900/20 bg-slate-50/50 dark:bg-blue-950/5 hover:bg-white dark:hover:bg-blue-950/10 hover:shadow-xl transition-all group flex flex-col h-full"
              >
                <div className="flex justify-between items-start mb-4">
                  <h4 className="text-lg font-bold group-hover:text-blue-600 dark:group-hover:text-blue-400 transition text-slate-900 dark:text-slate-100 leading-tight">
                    {project.title}
                  </h4>
                  <a
                    href={project.link}
                ...
                <p className="text-slate-600 dark:text-slate-500 text-sm mb-6 leading-relaxed flex-grow">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {project.tech.map((t, i) => (
                    <span
                      key={i}
                      className="text-[10px] font-mono font-medium text-blue-700 dark:text-blue-400/80 border border-blue-200/50 dark:border-blue-900/50 px-2.5 py-1 rounded-md bg-blue-50/50 dark:bg-blue-950/30 whitespace-nowrap shadow-sm"
                    >
                      {t}
                    </span>
                  ))}
        ...
        <section id="connect" className="mb-20 scroll-mt-24">
          <div className="p-12 rounded-3xl border border-blue-200 dark:border-blue-900/20 bg-slate-50 dark:bg-blue-950/5 text-center transition-all">
            <h3 className="text-[10px] font-bold text-blue-600 dark:text-blue-500 uppercase tracking-[0.4em] mb-4"></h3>
            ...
            <p className="mt-10 text-slate-500 dark:text-slate-400 text-sm max-w-md mx-auto leading-relaxed">
              Currently seeking new opportunities in Full Stack Development and
              Software Engineer roles. My inbox is always open!
            </p>
          </div>
        </section>
